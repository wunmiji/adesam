	...
	<div class="col">
		<div class="card">
			<div class="card-body">
				...
				<form method="POST" action="<?= '/contacts/' . $data->cipherId . '/update'; ?>"
						...
						<div class="row row-cols-md-2 row-cols-1 mb-4">
							...
							<div class="col">
								<input type="text" name="nickname" class="form-control" id="nicknameInput"
									value="<?= esc($data->nickname); ?>" placeholder="Enter NickName">
						...
						<div class="row mb-4">
							...
							<div class="col-md-5 col-12">
								<input type="tel" name="mobile" id="mobileInput" class="form-control"
									value="<?= esc($data->mobile); ?>" placeholder="Enter Mobile Number" />
					...
					<div>
						...
						<div class="mb-4">
							<input type="text" name="address" class="form-control" id="addressInput"
								value="<?= esc($dataAddress?->address); ?>" placeholder="Enter Address">
						...
						<div class="row">
							<div class="col-md-7 col-12 mb-4">
								<input type="text" name="postal_code" class="form-control" id="postalCodeInput"
									value="<?= esc($dataAddress?->postalCode); ?>" placeholder="Enter Postal Code">
								...
								<select class="form-select" name="countries" aria-label="Default select example">
									...
									<?php foreach ($countries as $key => $value): ?>
										<option
											...
											<?= ($value->name == $dataAddress?->countryName ?? '') ? 'selected' : ''; ?>>
											<?= $value->name; ?>
										</option>
									<?php endforeach; ?>
								</select>
