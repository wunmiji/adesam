                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px; font-family:'Barlow',sans-serif;">
                                            Password Reset</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <h6
                                            style="color:#1e1e2d; font-weight:400; margin:0;font-size:17px; font-family:'Barlow',sans-serif;">
                                            Hi, <?= $name; ?></h6>
                                        ...
                                        <a href="<?= base_url('/reset-password?token=' . $token) ?>"
                                            style="background: #FF66C4;text-decoration:none !important; border-radius: 0.25rem; font-weight:500; margin-top:35px; margin-bottom:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;">Reset
                                            Password</a>
