...
<head>
    ...
    <title>Email From Adesam Contact Form</title>
        ...
        <tr>
            <td>
                <table style="background-color: rgb(255, 102, 196); max-width:670px;  margin:0 auto; border: 0;" width="100%"
                    ...
                    <tr>
                        <td style="text-align:center; color: white; font-weight:600; font-size:18px; font-family:'Barlow',sans-serif;">Email From Adesam Contact Form</td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <div style="margin-bottom: 15px;">
                                            <h5 style="line-height:24px; font-weight:600; font-size:15px; font-family:'Barlow',sans-serif;">Subject</h5>
                                            <p style="line-height:24px; font-weight:400; font-size:15px; font-family:'Barlow',sans-serif;"><?= $subject; ?></p>
                                        </div>
